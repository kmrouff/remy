...
go to the same model through the vision API, up to six at once. Search calls
...
Recipe intake, both voice modes, pause and resume, and the saved library work
end to end. Accounts are verified against a real Supabase project.
